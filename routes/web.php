...
Route::get('/course/{slug}/lesson/{lesson}', [LessonController::class, 'show'])->name('course.lesson');
...
Route::post('/payment/complete/{enrollment}', [PaymentController::class, 'complete'])->name('payment.complete')->middleware('auth');
